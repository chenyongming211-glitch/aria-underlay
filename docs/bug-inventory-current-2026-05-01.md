...
1. Add operation summary retention/compaction for the JSONL local audit store.
2. Add audit write failure observability for fire-and-forget event recording.
3. Add product audit backend/UI/CLI integration on top of `OperationSummaryStore`
