...
1. Decide whether OIDC discovery and JWKS download live in the product API
   process or in an external local-file sync service.
2. Select the production ingress implementation for TLS, client authentication,
