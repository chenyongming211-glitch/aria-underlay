...
S6800 and S5560 real-device write/readback/cleanup acceptance is complete;
...
1. Extend Basic IPv4 ACL acceptance to the next target model only when an
   approved lab device is available.
